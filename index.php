                ...
                <div class="content-bottom-left">
                    <div class="categories">
                        <ul>
                            ...
                            <li><a href="#">Flojet</a></li>
                            <li><a href="#">Jabsco</a></li>
                            <li><a href="#">Singflo</a></li>
                            <li><a href="#">Max Flow</a></li>
                            <li><a href="#">Vitop</a></li>
                            <li><a href="#">Насосы ЭЦВ</a></li>
                            <li><a href="#">Sales</a></li>
                            <li><a href="#">Справочный матерал</a></li>
                        </ul>
                    </div>
                    <div class="buters-guide">
                        <h3>Карта сайта</h3>
                        <p><span>Калькулятор</span></p>
                        <p> -> Сюда вфигачить калькулятор <- </p>
                    </div>
...
<div class="footer">
    <div class="wrap">
        <div class="copy_right">
            <p>Телефон для связи: +7 (985) 308 6656, 8 (977) 166 0091</p>
        </div>
